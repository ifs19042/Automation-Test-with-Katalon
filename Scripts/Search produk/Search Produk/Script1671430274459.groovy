...
WebUI.setText(findTestObject('Navigasi/Field Search'), 'Mortal')

WebUI.click(findTestObject('Navigasi/Button search'))

WebUI.click(findTestObject('Navigasi/ProdukMortalCombat11'))
