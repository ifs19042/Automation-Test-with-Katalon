...
WebUI.setText(findTestObject('Register/RegisterEmail'), GlobalVariable.Username)

WebUI.setText(findTestObject('Register/RegisterPassword'), GlobalVariable.Password)

WebUI.setText(findTestObject('Register/ConfirmRegisPassword'), GlobalVariable.Password)

WebUI.click(findTestObject('Register/BtnRegister'))

WebUI.verifyElementText(findTestObject('InvalidLogin/Page_Home - PS Enterprise Gameshop/Pesan Eror'), 'Error: An account is already registered with your email address. Please log in.')
