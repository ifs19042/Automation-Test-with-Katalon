...
WebUI.check(findTestObject('Register/Female'))

WebUI.setText(findTestObject('Register/RegisterEmail'), 'tester26012001@gmail.com')

WebUI.setText(findTestObject('Register/RegisterPassword'), 'TestingRiski123')

WebUI.setText(findTestObject('Register/ConfirmRegisPassword'), 'TestingRiski123')
